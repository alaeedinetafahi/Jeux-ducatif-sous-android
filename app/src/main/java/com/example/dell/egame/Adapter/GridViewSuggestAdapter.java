package com.example.dell.egame.Adapter;
...
import com.example.dell.egame.quiz;
...
public class GridViewSuggestAdapter extends BaseAdapter {
    ...
    private quiz mainActivity;

    public GridViewSuggestAdapter(List<String> suggestSource, Context context, quiz mainActivity) {
