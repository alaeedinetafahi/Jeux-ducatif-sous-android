...
import com.example.dell.egame.Adapter.GridViewAnswerAdapter;
import com.example.dell.egame.Adapter.GridViewSuggestAdapter;
import com.example.dell.egame.Common.Common;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(result.equals(correct_answer))
                {
                    ...
                    GridViewSuggestAdapter suggestAdapter = new GridViewSuggestAdapter(suggestSource,getApplicationContext(),quiz.this);
